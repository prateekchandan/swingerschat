...
<td class="bodytable1">
	...
	<td class='leftcolumn'>
		...
		$sql="INSERT INTO blogcomments (blogid, memberid, article, date, reply) VALUES('$articleid','$memberid','$text1','$date','0')";
		if (!mysql_query($sql,$dbc)) {
			die('Error: ');
		}
		
		header("Location: blog2.php?articleid=$articleid#commentbox");
		exit();
