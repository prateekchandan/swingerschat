...
if (isset ($_POST['submit'])) {
	...
	if (empty($_POST['name'])) {
		header("Location: newsletteraddtemplate.php?&error=1");
		exit;
	}
	...
	if (!eregi ( '[a-z||0-9]@[a-z||0-9].[a-z]', $frommail ) ) {
		header("Location: newsletteraddtemplate.php?&error=3");
		exit;
	}
	

	
	$sql="INSERT INTO newsletter_templates (name, frommail, subject, message, message2, textmail, htmlmail) VALUES('$name','$frommail','$subject','$message','$message2','$textmail','$htmlmail')";
...
//Edit Photo Gallery
echo"<form enctype='multipart/form-data' action=\"newsletteraddtemplate.php\" method='post'>";
...
<td class=\"editpageright\">";
echo"<input type=\"checkbox\" name=\"textmail\" value=\"1\" />";
echo"</td><td class=\"editpagehints\">
...
<td class=\"editpageright\">";
echo"<input type=\"checkbox\" name=\"htmlmail\" value=\"1\" />";
echo"</td><td class=\"editpagehints\">
