...
if (isset ($_POST['submit'])) {
	...
	if (empty($_POST['name'])) {
		header("Location: editfield.php?error=1&pageid=$pageid&tablename=$tablename&fieldid=$fieldid");
		exit;
	}
...
echo"<form enctype='multipart/form-data' action=\"editcheckboxfield.php\" method='post'>";
...
This is the name of the checkbox to edit.
</td></tr>";
...
<input type=\"submit\" name=\"submit\" value=\"Edit Checkbox\" />
