...
if (isset ($_POST['submit'])) {
	...
	{	
		$sql="INSERT INTO product_option1_pics (productid, optionid, pic) VALUES('$productid','$optionid','$pic')";
		...
		header("Location: addoptionpic.php?productid=$productid&message=1");
		exit;
	}
} else {
...
<td class=\"editpageright\">";
	...
	echo"<form enctype='multipart/form-data' action=\"addoptionpic.php\" method='post'>
