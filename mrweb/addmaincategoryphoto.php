...
if (isset ($_POST['submit'])) {
	...
	{
		mysql_query("UPDATE `store_categories` SET `mainimage`='$pic' WHERE `id` = '$categoryid' ");
		...
		header("Location: addmaincategoryphoto.php?categoryid=$categoryid&message=1");
		exit;
	}
} else {
...
<td class=\"editpageright\">";
	...
	echo"<form enctype='multipart/form-data' action=\"addmaincategoryphoto.php\" method='post'>
...
This is the main image for this category.
</td></tr></table";
}
