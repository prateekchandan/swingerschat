...
if (isset ($_POST['submit'])) {
	...
	|| ($_FILES["pic1"]["type"] == "image/pjpeg") || ($_FILES["pic1"]["type"] == "image/jpg") || ($_FILES["pic1"]["type"] == "image/png") || ($_FILES["pic"]["type"] == "image/x-png"))
	{
		...
		$sql="INSERT INTO `products` (category, subcategory, name, description, price, quantity, featured, pic1, ounces, option1, option2, option3, option4, option5, option6, option7, option8, option9, option10, option11, option12, option13, option14, option15, option16, option17, option18, option19, option20) VALUES('$category','$subcategory','$name','$description','$price','$quantity','$featured','$pic1','$ounces','$option1','$option2','$option3','$option4','$option5','$option6','$option7','$option8','$option9','$option10','$option11','$option12','$option13','$option14','$option15','$option16','$option17','$option18','$option19','$option20')";
		...
		*/
		...
		$sql = "CREATE TABLE $tablename (id int AUTO_INCREMENT, filename varchar(200),caption varchar(1000), PRIMARY KEY (id))";
		if (!mysql_query($sql,$dbc)) {
			die('Error: ' . mysql_error());
		}
		...
		$pic1 = "noimage.jpg";
		$sql="INSERT INTO `products` (category, subcategory, name, description, price, quantity, featured, pic1, ounces, option1, option2, option3, option4, option5, option6, option7, option8, option9, option10, option11, option12, option13, option14, option15, option16, option17, option18, option19, option20, option21, option22, option23, option24, option25, option26, option27, option28, option29, option30) VALUES('$category','$subcategory','$name','$description','$price','$quantity','$featured','$pic1','$ounces','$option1','$option2','$option3','$option4','$option5','$option6','$option7','$option8','$option9','$option10','$option11','$option12','$option13','$option14','$option15','$option16','$option17','$option18','$option19','$option20','$option21','$option22','$option23','$option24','$option25','$option26','$option27','$option28','$option29','$option30')";
		if (!mysql_query($sql,$dbc)) {
			die('Error: ' . mysql_error());
		}
...
echo"
<tr>
<td class=\"editpageleft\">CAD Drawing:</td>
<td class=\"editpageright\">";
echo"<input type='file' name=\"pic2\" />";
echo"</td><td class=\"editpagehints\">
This is will be the .PDF file you for your CAD.
</td></tr>";
...
<td class=\"editpageright\">";
	...
	if ($rows > 0) {
		while ($r = mysql_fetch_array($result)) {
			...
			echo"<input type='checkbox' name='$spot' value='1' />";
			echo"</td>";
