...
// Edit Caption box using style in line 96 below.
...
document.write(brs+'<div style="position:absolute; top: 10px; left: 30px; z-index:5000; background-image:url(images/trans_black.png); background-repeat: repeat; color:#ffffff; padding:3px;" align="center">'+this.dp+'<span id="imgdsc'+this.issid+'">&nbsp;<\/span></div>\n');
...
// To show controls, remove display:none style from line 127 below

inter_slide.prototype.controls=function(){
var brs=this.addbr? '<br>' : ' &nbsp;';
if(!this.ics&&!this.no_c)
document.write('<div align="center" style="display:none;"><input id="prev'+this.issid+'" disabled type="button" value=" << " onclick="iss['+this.issid+'].changeimg(false, \'nav\');">\n'+
