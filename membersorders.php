...
?>
    <div>
    <table align="center" cellpadding="0px" cellspacing="5px" border="0px" class="cart" width="100%">
    <tr>
    ...
    <?php
    $result1 = mysql_query("SELECT * FROM `orders` WHERE `memberid` = '$memberid' AND `shipped` = '0' AND `paid` = '1'");
